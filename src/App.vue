<template>
  <div id="ancestor">
    <div class="container-fluid" id="app">
      <div class="row">
        <div class="sidebar col-md-3 col-sm-4 col-xs-12 sidebar">
          <div class="search">
            <input
              class="search__input"
              type="text"
          ...
          <div class="info">
            <div class="wrapper-left">
              <div class="currentWeather">
                {{ currentWeather.temp }}
                <span class="currentWeather__unit">°C</span>
              </div>
              <div class="weatherDesc">{{ currentWeather.summary }}</div>
              <div class="minMax">
                <div class="minMax__desc minMax__desc--left">
                  <div class="minMax__detail">
                    <i class="minMax__icon">▲</i>
                    {{ currentWeather.todayHighLow.todayTempHigh }}
                    <span class="minMax__unit">°C</span>
                  </div>
                  <div class="minMax__summary">at {{ currentWeather.todayHighLow.todayTempHighTime }}</div>
                </div>
                <div class="minMax__desc">
                  <div class="minMax__detail">
                    <i class="minMax__icon">▼</i>
                    {{ currentWeather.todayHighLow.todayTempLow }}
                    <span class="minMax__unit">°C</span>
                  </div>
                  <div class="minMax__summary">at {{ currentWeather.todayHighLow.todayTempLowTime }}</div>
                </div>
              </div>
            </div>
            <div class="wrapper-right">
              <div class="date-time-info">
                <div class="date">
                  <img class="date__icon" src="./assets/calendar.svg" width="20" height="20">
                  {{ currentWeather.time }}
                </div>
              </div>
              <div class="location-info">
                <div class="location">
                  ...
                  <div class="location__detail mt-1">
        ...
        <dashboard-content
          class="dashboard col-md-9 col-sm-8 col-xs-12 content"
